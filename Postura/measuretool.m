...
Hp(1) = uipanel('Title','Imagenes','Parent',Htb,...
    'Position',[x0(1),y0(5),x0(2)-x0(1),y0(6)-y0(5)]);
Hp(2) = uipanel('Title','Estado','Parent',Htb,...
    'Position',[x0(1),y0(4),x0(2)-x0(1),y0(5)-y0(4)]);
Hp(3) = uipanel('Title','Calibrar','Parent',Htb,...
    'Position',[x0(1),y0(3),x0(2)-x0(1),y0(4)-y0(3)]);
Hp(4) = uipanel('Title','Medida','Parent',Htb,...
    'Position',[x0(1),y0(2),x0(2)-x0(1),y0(3)-y0(2)]);
Hp(5) = uipanel('Title','Guardar','Parent',Htb,...
    'Position',[x0(1),y0(1),x0(2)-x0(1),y0(2)-y0(1)]);
Hp(6) = uipanel('Title','Opciones','Parent',Htb,...
...
uicontrol('String','Eliminar',...
    'ToolTipString','Eliminar las imágenes seleccionadas de la lista',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
Hb.pixelsize = uicontrol('String','-',...
    ...
    'Parent',Hp(3));
uicontrol('String','Calibrar',...
    'ToolTipString','calibrar en la imagen actual (dibujar una línea en el objeto Calibration)',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Limpiar',...
    'ToolTipString','Borre la Calibración para todas las imágenes seleccionadas',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
dy = 0.95*(y0(1)-y0(2));
uicontrol('String','Distancia (D)',...
    'ToolTipString','Medir la distancia entre dos puntos',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Polilínea (P)',...
    'ToolTipString','Medir la distancia a lo largo de una serie de puntos',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Circulos (O)',...
    'ToolTipString','Medir el radio de un círculo (definido por dos puntos)',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Caliper (C)',...
    'ToolTipString','Medir la distancia más corta entre una línea y un punto',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(3),dx,dy],...
...
uicontrol('String','Spline (S)',...
    'ToolTipString','Medir la distancia a lo largo de un camino curvado',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(3),dx,dy],...
...
uicontrol('String','Angulo (A)',...
    'ToolTipString','Mida el ángulo entre dos líneas (definido por tres puntos)',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(3),y0(3),dx,dy],...
...
uicontrol('String','Editar (E)',...
    'ToolTipString','mover un punto previamente definido',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Borrar (del)',...
    'ToolTipString','Borrar medidad',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Copiar)',...
    'ToolTipString','Copiar medida',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
y0 = linspace(0.99,0.01,3);
dy = 0.95*(y0(1)-y0(2));
uicontrol('String','Guardar Proyecto',...
    'ToolTipString','Guardar Proyecto ',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(3),dx,dy],...
...
uicontrol('String','Cargar Proyecto',...
    'ToolTipString','Cargar Proyecto',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(2),dx,dy],...
...
uicontrol('String','Guardar imagen PNG',...
    'ToolTipString','Guardar imagen',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(3),dx,dy],...
...
uicontrol('String','Guardar PDF',...
    'ToolTipString','Guardar PDF',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(2),dx,dy],...
...
uicontrol('String','Guardar Texto',...
    'ToolTipString','Guardar texto',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(3),y0(2),dx,dy],...
...
% --------------------------------------------
    function addpoint(varargin)
        ...
        if (click_count > 0) && (click_count == Nclicks)
            i = currentfig;
            Hs.String = sprintf('%s: Medida hecha',current_measure_type);
...
% ---------------------------------------------
    function calib_fun(varargin)
        ...
        elseif strcmpi(type,'apply')
            ...
            i = currentfig;
            if A(i).cal == 0
                set(Hs,'String','La imagen actual no está calibrada, no se aplica nada');
                return
            end
            c = A(i).cal;
            unit = A(c).unit;
            ...
            set(Hs,'String','La calibración de la imagen actual se aplica a la selección')
        elseif strcmpi(type,'clear')
            ...
            set(Hs,'String','Calibración borrada para las imágenes seleccionadas')
        end
    end
